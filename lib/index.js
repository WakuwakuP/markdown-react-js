...
MDReactComponent.propTypes = {
  ...
  onIterate: _propTypes.func,
  onGenerateKey: _propTypes.func,
  tags: _propTypes.object,
  presetName: _propTypes.string,
  markdownOptions: _propTypes.object,
  enableRules: _propTypes.array,
  disableRules: _propTypes.array,
  convertRules: _propTypes.object,
  plugins: _propTypes.array,
  className: _propTypessss.string
};
